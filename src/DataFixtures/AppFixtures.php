...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $lp->setColorPrimary('#2563eb');
        $lp->setColorSecondary('#64748b');
        $lp->setColorBackground('#ffffff');
        $lp->setColorText('#1e293b');
        $lp->setColorNavbarBg('#ffffff');
        $lp->setColorNavbarText('#1e293b');
        $lp->setColorFooterBg('#0f172a');
        $lp->setColorFooterText('#e2e8f0');
